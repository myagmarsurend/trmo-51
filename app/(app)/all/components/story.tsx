...
const Index = () => {
  ...
  const [totalIncome, setTotalIncome] = useState(
    data?.transactionall?.totalIncome | 0
  );
  const [totalExpense, setTotalExpense] = useState(
    data?.transactionall?.totalExpense | 0
  );
  const total = data?.walletall?.total;
  ...
  return (
    <PagerView style={styles.pagerView} initialPage={0}>
      ...
      >
        ...
        <Text style={styles.storyText}>{formatCurrency(total)}</Text>
        <View
          style={{
            position: "absolute",
            bottom: 50,
        ...
        >
          ...
          <Button
            ...
            onPress={() => {
              router.navigate("/screens/report");
            }}
